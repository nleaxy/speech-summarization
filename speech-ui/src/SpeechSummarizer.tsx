...
// ============================================================================
// НОВАЯ СТРУКТУРА ДЛЯ ТИПОВ СУММАРИЗАЦИИ (ЧТОБЫ НЕ ПИСАТЬ ИХ ДВАЖДЫ)
// ============================================================================
const SUMMARY_TYPES = {
  brief: "⚡ Кратко",
  detailed: "📄 Подробно",
...
export default function SpeechSummarizer() {
  ...
  // ============================================================================
  // НОВАЯ ФУНКЦИЯ: Загружаем типы суммаризации с бэкенда при старте
  // ============================================================================
  useEffect(() => {
  ...
  // ============================================================================
  // ПОЛНОСТЬЮ ПЕРЕПИСАННАЯ ЛОГИКА ОБРАБОТКИ
  // Теперь она работает асинхронно, с опросом статуса
  // ============================================================================
